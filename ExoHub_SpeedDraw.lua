...
W.Name = "Window"
W.Size = UDim2.new(0, 360, 0, 500)
W.Position = UDim2.new(0, 24, 0.5, -250)
...
minBtn.MouseButton1Click:Connect(function()
    ...
    if minimized then
        W:TweenSize(UDim2.new(0,360,0,54), Enum.EasingDirection.Out, Enum.EasingStyle.Quart, 0.25, true)
        minBtn.Text = "+"
    else
        W:TweenSize(UDim2.new(0,360,0,500), Enum.EasingDirection.Out, Enum.EasingStyle.Quart, 0.25, true)
        minBtn.Text = "—"
    end
end)
...
wm.Text = "EXO HUB  •  discord.gg/exohub"
...
-- // OPEN ANIMATION
W.Position = UDim2.new(-0.5, 0, 0.5, -250)
